  ...
  const experiences = [
    {
      ...
      type: "Permanent",
      description:
        "Modernized existing company website, designed and implemented landing pages, developed Settl (voucher-based platform), led new funeral services offering, and independently developed multiple client websites. Currently working on API integrations to enhance website functionalities.",
      achievements: [
    ...
    },
    {
      ...
      type: "Freelance",
      description:
        "Developed mobile application using React Native for school rugby engagement. Built entire app from concept to deployment, focusing on user engagement and live API data integration.",
      achievements: [
    ...
    },
    {
      ...
      type: "Internship",
      description:
        "Instrumental part of development team as Full Stack Developer Intern. Specialized in C# and ASP.NET Core Web APIs, focused on performance optimization, data fetching, and UI components in Angular.",
      achievements: [
    ...
    },
    {
      ...
      type: "Freelance",
      description:
        "Worked independently and in a team to solve problems, delivered on company/client expectations, and contributed to innovation and technology adoption.",
      achievements: [
    ...
    },
    {
      ...
      type: "Freelance",
      description:
        "Part of innovation team, contributed to user experience design, and developed/maintained frontend of web applications.",
      achievements: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            My professional journey in frontend development, building innovative
